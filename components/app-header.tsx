    ...
    <header className="no-print sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-5 py-3">
        <div className="flex min-w-0 items-center gap-4">
          <Link href="/" className="whitespace-nowrap font-semibold tracking-tight text-slate-950">
            SMM StoryBrief <span className="text-blue-600">Lite</span>
          </Link>
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/calendar"
            className="rounded-xl border border-slate-200 px-3 py-2 text-sm font-medium md:hidden"
          >
            Calendar
          </Link>
